...
<div class="blogIframe">
	<iframe src="{{ '/assets/plotly/p_mc_est.html' | relative_url }}" frameborder='0' scrolling='no' height="600px" width="800px"></iframe><br>
</div>
...
<div class="blogIframe">
	<iframe src="{{ '/assets/plotly/p_sc_avg.html' | relative_url }}" frameborder='0' scrolling='no' height="600px" width="700px"></iframe><br>
</div>
