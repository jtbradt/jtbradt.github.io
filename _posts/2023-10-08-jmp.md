...
<div class="blogIframe">
	<iframe src="{{ '/assets/plotly/p_entrysubs_combined.html' | relative_url }}" frameborder='0' scrolling='no' height="600px" width="800px"></iframe>
</div>
...
I compare the CSI's consumer subsidies to a number of alternative consumer rebate designs and climate policies, including a carbon tax.  I leave those results for the paper, which you can <a href="/assets/pdf/papers/Bradt_JMP.pdf" target="_blank">download here</a>. 
