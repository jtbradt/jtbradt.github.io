...
<iframe src="{{ '/assets/plotly/p_csi_combined.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="800px"></iframe><br>
...
These results suggest that the competing 

industry cost reductions outweigh the decrease in firms' incentives to reduce costs by expanded output. 
