...
description: Unconventional Industrial Policy in the US Residential Solar Industry<br><font color="#828282"> Job Market Paper </font>&emsp;&emsp; <a href="/assets/pdf/papers/Bradt_JMP.pdf" target="_blank">Download PDF</a> 
...
I use my model to implement a set of counterfactual policies in which I remove the CSI's consumer subsidies and replace them with entry subsidies of varying sizes.  These entry subsidies are similar in total magnitude to the CSI, ranging  \$2.1-8 billion in cost.
